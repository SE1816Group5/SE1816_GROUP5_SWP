...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            <style>
.search-box {
    background-color: rgba(255, 255, 255, 0.85); /* trắng mờ, 0.85 = 85% độ đục */
    padding: 20px;
    border-radius: 12px;
    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2);
        ...
        .bodysearch {
    position: absolute;
    top: 40%; /* hoặc 60% nếu muốn nằm dưới ảnh */
    left: 50%;
...
button.btn-primary {
    text-transform: none; /* giữ nguyên chữ viết */
}
    ...
    <body>
        ...
        <div class="search-box">
            ...
            <div class="search-header mb-3">
                <input type="text" class="form-control" placeholder="Tìm theo điểm đến hoặc hoạt động" style="flex: 1; margin-right: 10px;">
            ...
            <form class="row g-3 form-section">
                <div class="col-md-6">
                    <label class="form-label">Bạn muốn đi đâu <span style="color:red">*</span></label>
    ...
    <option value="Rome">Rome</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" min="2000-01-01" max="2025-12-31" name="start_date">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Ngày khởi hành đến</label>
                    <input type="date" class="form-control" min="2000-01-01" max="2025-12-31" name="end_date">
                </div>
