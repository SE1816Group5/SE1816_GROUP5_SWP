...
public class EmailUtil {
    ...
    private static final String EMAIL = "hungntce180765@fpt.edu.vn"; // Replace with your email
    private static final String PASSWORD = "mhuagcyjuhftnhxs"; // Replace with your app password
